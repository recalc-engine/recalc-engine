...
pub(crate) fn eval(_ctx: &EvalContext, args: &mut dyn CallArgs) -> Value {
    ...
    match args.shape(0) {
        ...
        // expression over a multi-cell range (`COLUMNS(B1:B7*1)`) or a
        // function-produced array is a computed array whose column count is not
        ...
        // other value is a true scalar → a 1×1 array → 1 column (unchanged).
